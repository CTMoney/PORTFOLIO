      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav">
          <li className="nav-item">
            <a className="nav-link" style={{ fontSize: 23 }} href="/">
              Home
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" style={{ fontSize: 23 }} href="/about">
              About
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-item nav-link" style={{ fontSize: 23 }} href="/contact">
              Contact
            </a>
          </li>
        </ul>
